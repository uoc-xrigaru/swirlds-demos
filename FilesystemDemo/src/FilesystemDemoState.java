...
/** The state is primarily a Fast Copyable Filesystem. A transaction is
 *  an update to the filesystem. For now that takes the form of a filename and
 *  its contents.
 */
public class FilesystemDemoState implements SwirldState {
  ...
  /** Create (or replace) a file whose pathname and contents are described
   *  in the transaction. Any intermediate directories that don't already exist
